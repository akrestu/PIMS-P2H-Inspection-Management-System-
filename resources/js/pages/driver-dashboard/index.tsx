...
function getGreeting(): { text: string; emoji: string; sub: string } {
    ...
    if (h < 12) {
        return {
            text: 'Selamat Pagi',
            emoji: '☀️',
            sub: 'Semoga perjalanan hari ini aman.',
        };
    }
    ...
    return {
        text: 'Selamat Malam',
        emoji: '🌙',
        sub: 'Hati-hati di jalan malam ini.',
    };
}
...
function P2hStatusBanner({
        ...
        return (
            <div className="px-4">
                ...
                >
                    ...
                    <div className="absolute -top-4 -right-4 h-24 w-24 rounded-full bg-amber-200/30 dark:bg-amber-600/10" />
                    <div className="absolute top-8 -right-1 h-12 w-12 rounded-full bg-orange-200/30 dark:bg-orange-600/10" />
                    ...
                    <div className="relative space-y-4 p-4">
                        ...
                        <div className="flex items-start justify-between gap-2">
                            <div className="flex items-center gap-2.5">
                                ...
                                <div>
                                    ...
                                    <p className="text-base leading-tight font-bold text-amber-900 dark:text-amber-200">
                                        P2H Belum Diisi!
                                    </p>
                                </div>
                            </div>
                            <Badge className="shrink-0 gap-1 bg-amber-500 text-xs text-white hover:bg-amber-500">
                        ...
                        <p className="text-xs leading-relaxed text-amber-800/80 dark:text-amber-300/80">
                            Kendaraan <strong>tidak boleh dioperasikan</strong>{' '}
                            sebelum Form P2H shift ini terisi.
                        </p>

                        {/* CTA Button */}
                        <Link href="/p2h/form">
                            <Button className="h-12 w-full gap-2 bg-amber-500 text-sm font-bold text-white shadow-md shadow-amber-500/20 hover:bg-amber-600 dark:bg-amber-600 dark:hover:bg-amber-700">
    ...
    return (
        <div className="px-4">
            ...
            >
                <div className="absolute -top-4 -right-4 h-20 w-20 rounded-full bg-emerald-200/30 dark:bg-emerald-600/10" />
                ...
                <div className="relative flex items-center gap-4 p-4">
                    ...
                    <div className="min-w-0 flex-1">
                        ...
                        <p className="text-base leading-tight font-bold text-emerald-900 dark:text-emerald-200">
                            P2H Sudah Selesai!
                        </p>
                    ...
                    <Link href="/p2h/form" className="shrink-0">
                        <Button
                            size="sm"
                            variant="outline"
                            className="h-8 gap-1.5 border-emerald-300 text-xs text-emerald-700 hover:bg-emerald-100 dark:border-emerald-700 dark:text-emerald-400 dark:hover:bg-emerald-950/60"
                        >
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0 flex-1">
                            ...
                            <p className="text-xs text-muted-foreground">
                                Total item yang ditandai TL dari semua P2H
                            </p>
                        </div>
                        <div className="shrink-0 text-right">
                            ...
                            {hasTL && (
                                <p className="mt-0.5 text-[10px] text-orange-600/70 dark:text-orange-400/70">
                                    item
                                </p>
                            )}
                        </div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex shrink-0 flex-col items-end gap-2">
                            {item.kondisi_akhir === 'Layak Pakai' ? (
                                <Badge className="h-5 gap-1 border-emerald-200 bg-emerald-100 px-1.5 text-[10px] text-emerald-700 hover:bg-emerald-100 dark:bg-emerald-950 dark:text-emerald-400">
            ...
            <CardContent className="flex flex-col items-center justify-center gap-4 py-12">
                ...
                <div className="space-y-1 text-center">
                    <p className="text-sm font-semibold">
                        Belum ada riwayat P2H
                    </p>
                    <p className="mx-auto max-w-[220px] text-xs leading-relaxed text-muted-foreground">
                        Riwayat P2H akan muncul di sini setelah kamu mengisi
                        form untuk pertama kali.
                    </p>
                </div>
                <Link href="/p2h/form">
...
export default function DriverDashboardIndex({
    shiftAktif,
    sudahP2hShiftIni,
    stats,
    history,
