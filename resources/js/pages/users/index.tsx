...
function JabatanBadge({ jabatan }: { jabatan: Jabatan | null }) {
    ...
    return (
        <span
            className={`inline-flex items-center rounded-full border px-2 py-0.5 text-xs font-medium ${JABATAN_META[jabatan]}`}
        >
            {jabatan}
        </span>
    );
    ...
    return (
        <div className="space-y-1.5">
            <Label className="text-sm font-medium">
                Unit yang Di-assign
                <span className="ml-1 font-normal text-muted-foreground">
                    (opsional, bisa beberapa)
                </span>
            </Label>
            <p className="text-xs text-muted-foreground">
                Jika diisi, driver hanya melihat unit ini di form P2H. Jika
                kosong, fallback ke Kategori Unit.
            </p>
            {units.length > 5 && (
...
>({
    ...
    return (
        <>
            ...
            <div className="space-y-1.5">
                ...
                <div className="relative">
                    ...
                    <Input
                        value={data.name}
                        onChange={(e) =>
                            setData('name' as keyof T, e.target.value)
                        }
            ...
            <div className="space-y-1.5">
                <Label className="text-sm font-medium">
                    NIK / NRPP <span className="text-destructive">*</span>
                </Label>
                <div className="relative">
                    ...
                    <Input
                        value={data.nik}
                        onChange={(e) =>
                            setData('nik' as keyof T, e.target.value)
                        }
                        placeholder="Nomor Induk Karyawan / NRPP"
            ...
            <div className="space-y-1.5">
                ...
                <div className="relative">
                    ...
                    <Input
                        ...
                        value={data.email}
                        onChange={(e) =>
                            setData('email' as keyof T, e.target.value)
                        }
            ...
            <div className="space-y-1.5">
                ...
                <div className="relative">
                    <Input
                        ...
                        value={data.password}
                        onChange={(e) =>
                            setData('password' as keyof T, e.target.value)
                        }
            ...
            <RoleSelect
                value={data.role}
                onChange={(v) => setData('role' as keyof T, v)}
                ...
                <>
                    ...
                    <div className="space-y-1.5">
                        ...
                        <Select
                            ...
                            onValueChange={(v) =>
                                setData('department' as keyof T, v)
                            }
                        >
                            <SelectTrigger className="h-10 w-full">
                ...
                <>
                    ...
                    <AssignedUnitsSelect
                        units={units.filter(
                            (unit) =>
                                (!data.jenis_unit ||
                                    unit.jenis_unit === data.jenis_unit) &&
                                (!data.site_id ||
                                    unit.site_id === data.site_id),
                        )}
                        selected={data.assigned_unit_ids}
                        onChange={(ids) =>
                            setData('assigned_unit_ids' as keyof T, ids)
                        }
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="flex max-h-[85vh] flex-col gap-0 p-0 sm:max-w-lg">
                <DialogHeader className="border-b px-6 py-4">
                    ...
                    <DialogDescription>
                        Buat akun user dengan role dan jabatan yang sesuai.
                    </DialogDescription>
                </DialogHeader>
                <form
                    id="user-add-form"
            ...
            <DialogContent className="flex max-h-[85vh] flex-col gap-0 p-0 sm:max-w-lg">
                <DialogHeader className="border-b px-6 py-4">
                    <div className="flex items-center gap-3 pb-1">
                        <Avatar
                            className={`h-10 w-10 ${avatarColor(user.name)}`}
                        >
                            <AvatarFallback
                                className={`text-sm font-bold text-white ${avatarColor(user.name)}`}
                            >
                    ...
                    <DialogDescription>
                        Perbarui data akun, role, jabatan, dan profil user.
                    </DialogDescription>
                </DialogHeader>
                <form
                    id="user-edit-form"
            ...
            <DialogContent className="max-w-sm">
                <DialogHeader>
                    ...
                    <DialogDescription className="text-center">
                        ...
                        akan dihapus permanen beserta semua data terkait.
            ...
            <DialogContent className="max-w-sm">
                <DialogHeader>
                    ...
                    <DialogDescription className="text-center">
                        ...
                        yang dipilih akan dihapus permanen. Akun Anda sendiri
                        dan akun admin tidak akan dihapus meskipun dipilih.
                        Tindakan ini tidak dapat dibatalkan.
                    </DialogDescription>
                </DialogHeader>
                <DialogFooter className="gap-2 sm:gap-0">
...
export default function UsersIndex({
    ...
    const applyFilters = useCallback(
        (s: string, r: string, j: string, pp: string) => {
            ...
            debounceRef.current = setTimeout(() => {
                router.get(
                    '/users',
                    { search: s, role: r, jabatan: j, per_page: pp },
    ...
    const handleSearch = (val: string) => {
        setSearch(val);
        applyFilters(val, roleFilter, jabatanFilter, perPage);
    };
    ...
    const handlePerPage = (pp: string) => {
        ...
        router.get(
            '/users',
            { search, role: roleFilter, jabatan: jabatanFilter, per_page: pp },
            { preserveState: true, replace: true },
        );
    };
    const resetFilters = () => {
                ...
                <Card>
                    <CardContent className="flex flex-wrap items-center gap-3 py-3">
                        ...
                        <div className="flex flex-wrap items-center gap-1.5">
                            ...
                            {(['admin', 'manager', 'driver'] as Role[]).map(
                                (r) => (
                                    <button
                                        key={r}
                                            ...
                                            >
                                                ...
                                                <TableCell>
                                                    <div className="flex min-w-0 items-center gap-2.5">
                                                        <Avatar
                                                            className={`h-8 w-8 shrink-0 ${avatarColor(u.name)}`}
                                                        >
                                                            <AvatarFallback
                                                                className={`text-xs font-bold text-white ${avatarColor(u.name)}`}
                                                            >
                                                                {getInitials(
                                                                    u.name,
                                                                )}
